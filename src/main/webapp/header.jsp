            ...
            <ul class="flex flex-col mt-4 font-medium md:flex-row md:mt-0 md:space-x-8">
                ...
                <li>
                    ...
                    <div id="client-dropdown" class="absolute hidden z-10 grid w-auto text-sm bg-reversoDark
                            border border-gray-100 rounded-lg shadow-md dark:border-gray-700 dark:bg-gray-700">
                        <div class="p-4 pb-0 text-gray-900 md:pb-4 dark:text-white">
                            <ul class="space-y-4" aria-labelledby="mega-menu-dropdown-button">
                                <li>
                                    <a href="generalServlet?societe=client&choix=afficher"
                                       class="text-reversoLight hover:bg-reversoLight hover:text-reversoDark">
                                        Afficher
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="text-reversoLight hover:bg-reversoLight hover:text-reversoDark">
                                        Créer
                                    </a>
                                </li>
                                <li>
